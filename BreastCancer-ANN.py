...
st.write("""
Upload a CSV file containing breast cancer data, and click the "Train Model" button to train an Artificial Neural Network (ANN) on the data. The model uses the Adam optimizer.
""")
